    ...
    <div className="pre-footer-cta-wrap">
      ...
      >
        ...
        <p className="pre-footer-subtitle">
          Let’s build something that moves your business forward. Share your
          priorities and explore a clear next step with us.
        </p>

        {/* Action Buttons */}
        <div className="pre-footer-actions">
          <Link className="cta-btn-primary" to="/contact?intent=consultation">
